...
- Mean lift delta: 0.4567 m
- Lift delta stddev: 0.0000 m
- Mean placement error: 0.0115 m
...
- Mean OMPL planning time: 0.0476 s
- Mean OMPL joint path length: 7.7746 rad
- Raw mean trial time: 217.35 s
- Valid-start mean trial time: 217.35 s
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| RRTConnectkConfigDefault | 1/1 (100.0%) | 1/1 (100.0%, 95% CI [20.7%, 100.0%]) | 0 | 0.0476 +/- 0.0000 s | 7.7746 +/- 0.0000 rad | 217.35 +/- 0.00 s | 0.0115 +/- 0.0000 m |
